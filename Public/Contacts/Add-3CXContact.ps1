...
function Add-3CXContact {
    ...
    if ($body.Count -eq 0) {
        throw "At least one parameter must be provided to create a contact."
    }

    return Get-3CXResult -Endpoint "/xapi/v1/Contacts" -Method 'POST' -Body $body
}